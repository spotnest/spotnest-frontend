        ...
        <article className="group flex overflow-hidden rounded-2xl border border-[#e1e3e4] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.05)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(10,25,47,0.1)]">
            <div className="flex w-full flex-col">
                <Link
                    ...
                    className="relative block aspect-[1.55/1] overflow-hidden bg-[#e7e8e9]"
                >
                    {image ? (
                        <Image
                            src={image}
                ...
                <div className="flex flex-1 flex-col p-5">
                    ...
                    <p className="mt-2 flex items-center gap-1.5 text-sm text-[#44474d]">
                        <svg
                            aria-hidden="true"
                            className="h-4 w-4 shrink-0 text-[#00696b]"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth="1.8"
                        >
                            <path
                                ...
                                d="M19 10c0 5.25-7 10-7 10S5 15.25 5 10a7 7 0 1 1 14 0Z"
                            />
                            <path
                                strokeLinecap="round"
                                strokeLinejoin="round"
                    ...
                    <div className="mt-5 flex flex-wrap gap-x-3 gap-y-1 border-t border-[#e7e8e9] pt-4 text-xs font-medium text-[#44474d]">
                        {property.bedrooms > 0 && (
                            <span className="inline-flex items-center gap-1.5">
                                <span
                                    aria-hidden="true"
                                    className="h-1 w-1 rounded-full bg-[#00696b]"
                                />
                                {property.bedrooms}{" "}
