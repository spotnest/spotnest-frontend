    ...
    <section className="px-4 pb-20 sm:px-6 lg:px-10 lg:pb-24">
      <div className="mx-auto max-w-[1280px]">
        <div className="relative overflow-hidden rounded-3xl bg-[#050a0b] px-6 py-14 text-center text-white sm:px-10 sm:py-16 lg:py-20">
          <div
            aria-hidden="true"
            className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[#00696b]/35 blur-3xl"
          />
          <div
            aria-hidden="true"
            className="absolute -bottom-28 -left-16 h-64 w-64 rounded-full bg-[#56f5f8]/10 blur-3xl"
          />
