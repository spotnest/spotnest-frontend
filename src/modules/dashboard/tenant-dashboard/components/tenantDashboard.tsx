...
const quickActions: QuickAction[] = [
    ...
    {
        label: "My Requests",
        description: "Track rental & viewing requests",
        href: "/bookings",
        icon: "inbox",
    },
    {
        label: "My Rental",
        description: "View your current lease details",
        href: "#rental",
        icon: "home",
    },
    {
        label: "Pay Rent",
        description: "Manage dues & payment methods",
        href: "#payments",
        icon: "clock",
        accent: true,
    },
                ...
                <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="space-y-8 lg:col-span-2">
                        ...
                        <section className="rounded-2xl border border-[#e1e3e4] bg-white p-6 shadow-xs">
                            ...
                            <div className="py-10 text-center">
                                ...
                                <p className="mt-3 text-sm font-semibold text-[#191c1d]">
                                    No recent activity
                                </p>
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-1 flex-col p-5">
                                            <div className="flex items-start justify-between gap-2">
                                                ...
                                                <span className="shrink-0 text-sm font-bold text-[#00696b]">
                                                    {prop.price}
                                                </span>
                                            </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <section className="rounded-2xl border border-[#e1e3e4] bg-white p-6 shadow-xs">
                            ...
                            <p className="mb-5 text-xs text-[#75777e]">
                                    ...
                                    <Link
                                        ...
                                        className={`flex flex-col items-center justify-center rounded-xl p-4 text-center transition ${
                                            action.accent
                                                ...
                                                : "border border-transparent bg-[#f8f9fa] text-[#191c1d] hover:border-[#e1e3e4] hover:bg-[#f3f4f5]"
                                        }`}
                                    >
                                        <span className="mb-2">
                                            <Icon
                        ...
                        >
                            ...
                            <div className="py-6 text-center">
                                ...
                                <p className="mt-3 text-sm font-bold text-[#191c1d]">
                                    No pending payments
                                </p>
                            ...
                            <div className="rounded-xl bg-[#f8f9fa] p-3 text-[11px] text-[#75777e]">
                                ...
                                SpotNest uses end-to-end encrypted payment
                                processing.
                            </div>
                        </section>
                        ...
                        >
                            ...
                            <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                                <div className="rounded-xl bg-[#f8f9fa] p-3">
                                    ...
                                    <span className="text-[10px] font-semibold uppercase text-[#75777e]">
                                        Open
                                    </span>
                                </div>
                                ...
                                <div className="rounded-xl bg-[#f8f9fa] p-3">
                                    <span className="block text-lg font-bold text-[#00696b]">
                                        0
                                    </span>
                            ...
                            <p className="mt-4 text-center text-xs text-[#75777e]">
                                Have an urgent repair? Our property owners
                    ...
                    <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
                        ...
                        {maintenanceSuccess ? (
                            <div className="py-8 text-center">
                                ...
                                <h4 className="mt-3 text-base font-bold text-[#191c1d]">
                                    Request Submitted
                                </h4>
                            ...
                            >
                                <div>
                                    <label className="mb-1 block text-xs font-semibold text-[#191c1d]">
                                        Category
                                    </label>
